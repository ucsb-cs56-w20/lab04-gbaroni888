...
public class RationalTest {
   ...
   @Test
    ...
    @Test
    public void test_lcm_of_r_13_4() {
	    assertEquals(52,Rational.lcm(13,4));
    }
 
    @Test
    public void test_lcm_of_r_m3_7() {
	    assertEquals(21,Rational.lcm(-3,7));
    }
    @Test
    public void test_plus_r_5_15_r_20_25() {
    	assertEquals("17/15", r_5_15.plus(r_20_25).toString());
    }

    @Test
    public void test_plus_r_0_1_r_20_25() {
    	assertEquals("4/5", r_0_1.plus(r_20_25).toString());
    }

    @Test
    public void test_plus_r_m5_15_r_20_25() {
    	Rational temp = new Rational(-5,15);
	assertEquals("7/15", temp.plus(r_20_25).toString());
    }

    @Test
    public void test_minus_r_5_15_r_20_25() {
    	assertEquals("-7/15", r_5_15.minus(r_20_25).toString());
    }

    @Test
    public void test_minus_r_0_1_r_20_25() {
    	assertEquals("-4/5", r_0_1.minus(r_20_25).toString());
    }

    @Test
    public void test_minus_r_m5_15_r_20_25() {
    	Rational temp = new Rational(-5,15);
	assertEquals("-17/15", temp.minus(r_20_25).toString());
    }

    @Test
    public void test_reciprocalOf_r_13_4() {
	    assertEquals(4,r_13_4.reciprocalOf().getNumerator());
    }
    @Test
    public void test2_reciprocalOf_r_13_4() {
	    assertEquals(13,r_13_4.reciprocalOf().getDenominator());
    }
    ...
    @Test
    public void test_dividedBy_r_5_15_r_20_25() {
    	assertEquals("5/12", r_5_15.dividedBy(r_20_25).toString());
    }

    @Test
    public void test_dividedBy_r_0_1_r_20_25() {
    	assertEquals("0", r_0_1.dividedBy(r_20_25).toString());
    }

    @Test
    public void test_dividedBy_r_m5_15_r_20_25() {
    	Rational temp = new Rational(-5,15);
	assertEquals("-5/12", temp.dividedBy(r_20_25).toString());
    }
